...
<!---I detta formulerar Kant den princip han benämner "det *kategoriska imperativet*" (den *allmänna* princip utifrån vilken vi avgör vad som är en plikt och ej). --> 
...
<!---TIDIGARE FORMULERING: Detta ska dock inte sammanblandas med den typ av underliggande principer vi exempelvis utgår ifrån då vi i början av dagen väljer mellan en vit eller en svart t-shirt. Att jag väljer en vit t-shirt framför en svart innebär inte att jag måste vilja att *alla andra* ska utgå ifrån en regel så som: ”jag passar bättre i vitt”. Denna handling har kort och gott *ingen moralisk betydelse*. Detta eftersom den underliggande regeln inte bär på något allmängiltigt. Således är handlingen att bära en vit t-shirt en *neutral* handling (åtminstone vad gäller moral).-->
...
Detta öppnar också upp för att vi kan ha olika plikter gentemot olika personer. Kanske är det en plikt att vara givmild gentemot sina vänner och samtidigt ingen plikt att vara givmild mot sina ovänner? I vart fall är det, enligt Kant, exempelvis inte en plikt att ta hand om andras barn på samma sätt som det är en plikt att ta hand om sina egna. 
