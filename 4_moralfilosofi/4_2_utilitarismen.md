...
<!--blir skillnaden mellan "verklighet" och "illusion" mindre betydelsefull-->
...
<!--Här kan jag göra en koppling till kapitlet som följer-->

<!--se även: min tenta om elevdemokrati. (framtida önskningar vs önskningar just nu)-->

## Riktighetskriterium & beslutsmetod

Utilitarismen ger oss ett på ytan enkelt sätt att avgöra om en handling är rätt eller fel. Men i praktiken är det, som vi nu sett, något svårare. När vi handlar kan vi, som sagt, aldrig på förhand *veta* vilka konsekvenserna kommer att bli. Av denna anledning skiljer man därför mellan den utilitaristiska principen som ett *riktighetskriterium* och utilitarismen som en *beslutsmetod*. 

I "grundvarianten" av utilitarismen är riktighetskriteriet att *den rätta handlingen alltid producerar den största möjliga mängden (faktisk) lycka*. Beslutsmetoden, alltså den princip man utgår ifrån i en *konkret situation*, kan dock vara en annan. 
...
De som intar den första positionen menar att det är underordnat *hur* vi kommit fram till den moraliskt rätta handlingen. Det viktiga är *att* vi gjort det. Dessa utilitarister menar att det inte alltid lämpar sig att *tänka* utilitaristiskt: att utilitarismen, paradoxalt nog, inte nödvändigtvis är den bästa *metoden* för  moraliska beslut och att vi tvärtom riskerar att handla mycket dåligt om vi vid varje tillfälle försöker räkna på varenda liten konsekvens. Denna position öppnar därmed också upp för ”vänsterprassel” med övriga moralfilosofier, eftersom andra moralfilosofiska tankesätt eventuellt kan ge oss bättre *metoder* för vårt moraliska handlande. 

Utilitarismen är för dessa utilitarister alltså, på sin höjd, endast ett verktyg för att först *i efterhand* kunna avgöra om en handling var rätt eller fel. Om nu ens det: för även om det i praktiken skulle vara omöjligt att veta om vi handlat (helt) rätt, såväl före som efter, så kan detta i sig inte utgöra någon kritik mot riktighetskriteriet. Eller för att ta ett motsvarande exempel: om det är sant att universum är oändligt är detta sant oberoende av vår förmåga att kunna greppa eller se denna oändlighet. Riktighetskriteriet kan alltså vara korrekt även om vi *aldrig någonsin kan veta* om en handling varit rätt eller fel.  

De som intar den andra positionen menar istället att utilitarismen inte bör förlora sin *praktiska* relevans för våra moraliska beslut och att det faktiskt *går* att utgå ifrån den utilitaristiska principen (riktighetskriteriet) för att formulera en beslutsmetod. Dessa talar här om att vi ska handla så att vi maximerar den *rationellt förväntade nyttan* snarare än den "faktiska" nyttan. 

Med detta menas att vår beslutsmetod, såväl som vårt riktighetskriterium, inte kan grunda sig i de konsekvenser som en handling *faktiskt ger* utan att dessa alltid måste utgå ifrån de konsekvenser vi *tror* att vår handling kommer att ge. Att vår beräkning av den förväntade nyttan måste vara *rationell* innebär dock att vi alltid måste göra en viss *ansträngning* i det handlingsunderlag vi skapar oss: vi kan inte bara ”handla på en höft”. 

En stor anledning till att man formulerar riktighetskriteriet på detta sätt är därtill att man annars riskerar att få ganska stora problem med frågan om klander- och prisvärdighet. Ett exempel som gör detta tydligt är när man av *misstag* råkar utföra en värdefull handling. I en sådan situation bör man rimligen inte prisas (få beröm) för sin handling – hur goda konsekvenser den än fört med sig. 

Tänk dig följande scenario: Det är fredag och jag ska på en fest hos en bekant. Tidigare under dagen har jag erbjudit en nära vän att följa med. Denna vän ringer nu och frågar vilken tid som gäller. Jag har av oklar anledning inte längre någon större lust att ta med mig min vän, så jag ljuger och säger att jag bestämt mig för att inte gå. Min vän, som själv inte känner personen som har festen, väljer nu därför att "också" stanna hemma. Detta visar sig vara oerhört tur eftersom min väns mamma just denna kväll drabbas av en stroke och min vän (som är den enda hemma tillsammans med mamman) kan ringa efter ambulans. 

I detta exempel har min handling förvisso producerat goda konsekvenser, men jag har likväl inte handlat *för* att jag *förväntade* mig dessa konsekvenser. Av denna anledning kan jag inte heller ta på mig någon större ära för det som inträffat – hur *tur det än var* att jag gjorde som jag gjorde. 
...
<iframe src="https://docs.google.com/forms/d/1vwDQVeoUvKI842liEKD3TcCePnAymkQHwd0dwTy7aNc/viewform?embedded=true" width="100%" height="1100" frameborder="0" marginheight="0" marginwidth="0">Läser in...</iframe>