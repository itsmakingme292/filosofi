...
**Repeterande ordförklaring:** Begreppet subjekt syftar till "det som upplever" (vanligen en människa), begreppet objekt syftar till allt som kan upplevas (ex saker). Begreppen subjektiv och objektiv handlar om distinktionen mellan den inre och yttre verkligheten. En subjektiv uppfattning är *personlig*, den handlar om _hur något upplevs_. Den objektiva verkligheten handlar tvärtom hur saker är _oberoende_ av vår *personliga* uppfattning – hur saker _faktiskt_ är (en verklighet som vi enligt relativismen aldrig kan nå). 
