...
**Repeterande ordförklaring:** Begreppet _subjekt_ syftar till "det som upplever" (vanligen en människa), begreppet _objekt_ syftar till allt som kan upplevas (ex saker). Begreppen subjekt*ivt* och objekt*ivt* handlar om distinktionen mellan den inre och yttre verkligheten. En subjektiv uppfattning är *personlig*, den handlar om _hur något upplevs_. Den objektiva verkligheten handlar tvärtom hur saker är _oberoende av vår personliga uppfattning_ – hur saker _faktiskt_ är (en verklighet som vi enligt relativismen aldrig kan nå). 
...
Vad gäller den första frågan står den vanligaste skiljelinjen mellan de som anser att *all* kunskap är relativ och de som anser att endast "kunskap" som rör [värdepåståenden](../2_fil_verktyg/2_2_2_sprak_satser.md) är relativ (moral och/eller estetik). De första kallas **kunskapsrelativister** och de senare för **värderelativister**.  Man skulle förvisso kunna *tänka sig* en variant där man endast är kunskapsrelativist, men inte värderelativist, men detta är ganska ovanligt. Oftast är det moralen och/eller estetiken som faller för relativistiska synsätt först. Därför brukar kunskapsrelativism också *implicera* en värderelativism, men inte vice versa. 
