...
<!-- I en **argumentationanalys** ser vi till två olika egenskaper hos argumenten för att avgöra värdet eller styrkan hos dem. Dessa egenskaper är _hållbarhet_ och _relevans_. -->
...
<!--Få in något om beviskraft här? Vilket alltså är en effekt av hållbarhet+relevans och ej är binärt utan skalärt -->


## Olika nivåer av argument

När man argumenterar gör man oftast detta i _flera led_. Med andra ord: man argumenterar för eller emot en tes med flera påståenden som i sin tur styrks av ytterligare påståenden. När man analyserar argument kan man därför dela upp argumentationen i _olika nivåer_ för att på så vis få en tydligare överblick. Inom filosofin kallas detta för att dela upp argumenten i **argument av olika ordning**.
...
Inom filosofin är vi noga med att både *undvika* och *syna* argumentationsfel. Här följer en lista över några av de vanligast förekommande.
...
**Personangrepp** (på latin: Ad Hominem) är i stort sett raka motsatsen till auktoritetsargument. Här *avfärdar* man istället en annan persons påståenden och argument genom att hänvisa till dennes (påstådda och oftast _negativa_) egenskaper. Man attackerar därmed _personen_ istället för det den säger.
...
> *Exempel på hänvisning till okunskap:*  
> 
...
<iframe src="https://docs.google.com/forms/d/14bKEVfUJV9OPYs0_vJYuPmvEvpwTL_pRsjkbXd0AHYA/viewform?embedded=true" width="760" height="1100" frameborder="0" marginheight="0" marginwidth="0">Läser in...</iframe>